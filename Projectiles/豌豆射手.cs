...
{
    public class 豌豆射手 : 普通植物
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("豌豆射手");
        }
        ...
        public override void AI()
        {
            ...
            if (敌(projectile, false))
            {
                ...
                {
                    projectile.ai[1] = 0;
                    Projectile.NewProjectile(projectile.Center, new Vector2(5, 0), ModContent.ProjectileType<豌豆>(), projectile.damage, 0, projectile.owner);
                }
