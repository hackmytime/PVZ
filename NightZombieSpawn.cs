...
namespace PVZ
{
	internal class NightZombieSpawn
	{
		...
		public static void NPCs()
		{
			...
			switch (pvz)
			{
				...
				default: NPC.NewNPC((int)vector.X, (int)vector.Y, Main.rand.Next(NPCs10)); break;
			}
		}
		...
		{
			ModContent.NPCType<普通僵尸>(),ModContent.NPCType<持剑僵尸>(),ModContent.NPCType<路障僵尸>()
		};
		public static int[] NPCs3 = new int[]
		{
			ModContent.NPCType<普通僵尸>(),ModContent.NPCType<路障僵尸>(),ModContent.NPCType<路障僵尸>(),ModContent.NPCType<持剑僵尸>()
		};
		public static int[] NPCs4 = new int[]
		{
			ModContent.NPCType<普通僵尸>(),ModContent.NPCType<路障僵尸>(),ModContent.NPCType<持剑僵尸>(),ModContent.NPCType<铁桶僵尸>()
		};
		...
		public static int[] NPCs10 = new int[]
		{
			ModContent.NPCType<普通僵尸>(),ModContent.NPCType<路障僵尸>(),ModContent.NPCType<持枪僵尸>(),ModContent.NPCType<巨型路障僵尸>(),ModContent.NPCType<橄榄球头盔僵尸>(),ModContent.NPCType<勇士僵尸>()
		};
	}
}