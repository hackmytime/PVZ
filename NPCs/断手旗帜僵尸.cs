...
namespace PVZ.NPCs
{
	public class 断手旗帜僵尸 : 僵尸
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("旗帜僵尸");
		...
		public override void AI2()
		{
			if (npc.life <= 70)
			{
				Gore.NewGore(npc.position, npc.velocity, 154, 1f);
				Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/破损的旗帜"), 1f);
				float ai = npc.localAI[3];
				npc.Transform(ModContent.NPCType<无头旗帜僵尸>());
				npc.localAI[3] = ai;
